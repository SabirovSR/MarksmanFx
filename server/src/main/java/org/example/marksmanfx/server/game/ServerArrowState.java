...
/**
 * Server-side arrow — exact physics port from ArrowModel.
 * One instance per player; re-activated on each shot.
 */
public final class ServerArrowState {
    ...
    /** Tip of the arrowhead — used for collision detection. */
    public double tipX() {
