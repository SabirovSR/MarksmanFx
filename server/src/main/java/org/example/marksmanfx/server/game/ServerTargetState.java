...
/**
 * Серверное изменяемое состояние мишени: точный перенос физики из TargetModel.
 * Координата X и размер фиксированы, а Y колеблется между верхней и нижней границей.
 */
